...
export const DateCells = (date) => {
  const calDate = new Date(date.date);
  const monthName = calDate.toLocaleString("default", { month: "short" });
  const dateStr = calDate.getDate();
  return (
    <div className="dateCell border-box-border rounded-lg bg-tile-color w-48 text-center flex flex-col items-center py-5">
